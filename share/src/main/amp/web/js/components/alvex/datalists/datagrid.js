    ...
    YAHOO.lang.augmentObject(Alvex.DataGrid.prototype, {
        ...
        renderDataListMeta: function DataGrid_renderDataListMeta() {
            ...
            Alfresco.util.populateHTML(
                [this.id + "-title", $html(this.datalistMeta.title)], [this.id + "-listType", $links($html("(" + this.datalistMeta.itemTypeTitle + ")", true))], [this.id + "-description", $links($html(this.datalistMeta.description, true))]
            );
        },
        ...
        createConfigurePageWidgets: function() {
            ...
            this.widgets.configurePageDialogCancel = new YAHOO.widget.Button(dialogId + '-cancel', {
                onclick: {
                    fn: this.onConfigureCancel,
                    obj: null,
                    scope: this
                }
            });

            this.widgets.configurePageDialog = Alfresco.util.createYUIPanel(dialogId, {
                width: "800px"
            });
